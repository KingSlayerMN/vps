...
Step 3) Once install script has finished type: nano /etc/masternodes/crowd_n1.conf
		...
		now place your masternode private keys here masternodeprivkey=HERE_GOES_YOUR_MASTERNODE_KEY_FOR_MASTERNODE_crowd_1
...
Step 4) To activate the masternode type: run activate_masternodes_crowd and wait for the new MN to be fully synced
